...
function setupMobileMenu() {
    ...
    // Fechar menu ao clicar fora (com tratamento de erro)
    try {
    ...
    // Fechar menu ao pressionar ESC (com tratamento de erro)
    try {
    ...
    // Melhorar z-index do header quando menu está aberto
...
function setupMobileParticles() {
    ...
    if (!particlesContainer || !particles.length) return;
    ...
    // Pausar animações quando a página não está visível (com tratamento de erro)
    try {
