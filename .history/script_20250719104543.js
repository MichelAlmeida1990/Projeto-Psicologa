...
// ==================== MOBILE MENU COMPLETAMENTE RECRIADO E OTIMIZADO ====================
function setupMobileMenu() {
    ...
    // Fechar menu ao redimensionar a tela (se estiver aberto)
...
function setupMobileParticles() {
    ...
    if (isMobile) {
        ...
        // Garantir que o container esteja visível e com z-index correto
